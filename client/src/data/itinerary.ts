...
export const itineraryData: DayItinerary[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "09.35 น. เดินทางต่อไปควีนส์ทาวน์ เที่ยวบิน QF121",
      "เดินทางถึงควีนส์ทาวน์ นิวซีแลนด์ เวลา 14:35 น.",
  ...
  },
  {
    ...
    locations: [
      {
        ...
        description: "โรงภาพยนตร์มัลติมีเดีย 4D ใต้น้ำ พาผู้ชม \"ย้อนเวลา\" ไปเรียนรู้เรื่องราวของทะเลสาบวาคาทีปู ตั้งแต่ยุคน้ำแข็งจนถึงตำนานของชนเผ่าเมารี",
        images: []
      },
      {
      ...
      },
      {
        ...
        description: "ฟาร์มเลี้ยงแกะสุดคลาสสิกริมทะเลสาบ สัมผัสวิถีชีวิตชนบทของชาวนิวซีแลนด์ ชมการแสดงสุนัขต้อนแกะและการตัดขนแกะ",
        images: []
      },
      {
    ...
    highlights: [
      "กิจกรรม Time Tripper 4D",
      "ล่องเรือกลไฟโบราณ TSS Earnslaw",
      "ชมการตัดขนแกะที่ Walter Peak Farm",
      "รับประทานอาหารบาร์บีคิวสไตล์ฟาร์ม",
      "ชมบันจี้จัมพ์ที่สะพานคาวารัว",
      "เดินเล่นที่เมืองแอโรว์ทาวน์",
