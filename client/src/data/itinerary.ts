...
export const itineraryData: DayItinerary[] = [
  ...
  },
  {
    ...
    locations: [
      ...
      {
        name: "Puzzling World",
        description: "📸 ถ่ายภาพสุดเก๋! แวะเช็คอินที่ Puzzling World แลนด์มาร์กสุดแปลกตาของวานากะ อาคารดีไซน์ล้ำที่เล่นกับมุมมองและภาพลวงตา ไม่ว่าจะเป็นหอคอยเอียง (Leaning Tower) หรือสถาปัตยกรรมชวนมึน เตรียมกล้องให้พร้อม เพราะทุกมุมคือจุดถ่ายภาพสนุก ๆ ที่จะทำให้เพื่อน ๆ สงสัยว่า... จริงหรือหลอกกันแน่!",
      ...
      },
      {
        ...
        images: ["/images/clay-cliffs-omarama.webp", "/images/istockphoto-1484576292-612x612.jpg"]
      },
      {
